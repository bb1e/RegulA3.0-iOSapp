//
//  ByEstrategiaViewController.swift
//  ProjetoRegula3.0
//
...
class ByEstrategiaViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        navbar.title = tituloEstrategia
        dataManager = DataManager()
        dataManager.fetchEstrategiasByTipoAndTitulo(tipo: tipoEstrategia ?? " ", titulo: tituloEstrategia ?? " "){ result in
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "goToDetalhes", sender: nil)
    }
